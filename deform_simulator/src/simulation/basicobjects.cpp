...
EnvironmentObject::Ptr PlaneStaticObject::copy(Fork &f) const
{
...
EnvironmentObject::Ptr CylinderStaticObject::copy(Fork &f) const
{
...
EnvironmentObject::Ptr SphereObject::copy(Fork &f) const
{
...
EnvironmentObject::Ptr BoxObject::copy(Fork &f) const
{
...
EnvironmentObject::Ptr CapsuleObject::copy(Fork &f) const
{
