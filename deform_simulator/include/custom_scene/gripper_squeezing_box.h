#ifndef GRIPPERSQUEEZINGBOX_H
#define GRIPPERSQUEEZINGBOX_H

#include "simulation/simplescene.h"
#include "simulation/softbodies.h"

class GripperSqueezingBox : public CompoundObject<BoxObject>
{
    public:
        typedef boost::shared_ptr<GripperSqueezingBox> Ptr;
