...
class CustomScene : public Scene
{
    ...
    private:
        ...
        std::vector<boost::shared_ptr<osgbCollision::GLDebugDrawer>> dbgDraw_forks;
        std::vector<osgViewer::Viewer> viewer_forks;
        std::vector<osg::ref_ptr<EventHandler>> manip_forks;
        std::vector<std::function<void()>> draw_function_forks;
        ...
        void createVisualizerForFork(SimForkResult& fork_result, const int fork_ind);
